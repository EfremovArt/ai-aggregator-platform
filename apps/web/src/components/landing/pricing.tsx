...
const TEXT: Row[] = [
  { model: 'GPT-4o', provider: 'OpenAI', ctx: '128K', price: '₽0.25 / ₽1.00', sub: 'input / output · 1K токенов' },
  { model: 'GPT-4o mini', provider: 'OpenAI', ctx: '128K', price: '₽0.015 / ₽0.06' },
  { model: 'Claude 3.5 Sonnet', provider: 'Anthropic', ctx: '200K', price: '₽0.30 / ₽1.50' },
  { model: 'Claude 3.5 Haiku', provider: 'Anthropic', ctx: '200K', price: '₽0.08 / ₽0.40' },
  { model: 'Gemini 2.0 Flash', provider: 'Google', ctx: '1M', price: '₽0.01 / ₽0.04' },
  { model: 'DeepSeek V3', provider: 'DeepSeek', ctx: '128K', price: '₽0.027 / ₽0.11' },
  { model: 'Mistral Large', provider: 'Mistral', ctx: '128K', price: '₽0.20 / ₽0.60' },
  { model: 'Grok 2', provider: 'xAI', ctx: '128K', price: '₽0.20 / ₽1.00' },
  { model: 'Qwen 2.5 72B', provider: 'Alibaba', ctx: '128K', price: '₽0.04 / ₽0.12' },
];
...
const AUDIO: Row[] = [
  ...
  { model: 'Whisper', provider: 'OpenAI', price: 'от ₽0.6', sub: 'за минуту аудио (распознавание)' },
  ...
  return (
    <section id="pricing" className="relative border-b border-white/[0.06] py-20">
      <div className="container">
        ...
        <PriceTable title="Текст и код" rows={TEXT} />
  ...
  return (
    <div className="mt-12">
      <div className="mb-4 flex items-baseline justify-between">
        ...
        <span className="text-xs text-muted-foreground">{rows.length} {rows.length > 4 ? 'моделей' : 'модели'}</span>
      </div>
